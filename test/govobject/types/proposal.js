...
describe('Proposal', function() {
  ...
  var validJSONProposal = {
    ...
    end_epoch: endDate,
    payment_address: 'DXGeNPQXYFXhLAN1ZKrAjxzzBnZ2JZNKnh',
    payment_amount: 10,
    type: 1,
        url:"http://www.duality.solutions"
  };
  it('should create new proposal', function() {
    ...
    proposal.payment_address = 'DXGeNPQXYFXhLAN1ZKrAjxzzBnZ2JZNKnh';
  ...
  it('should throw error if payment address is invalid', function() {
    ...
    proposal.end_epoch = endDate;
    proposal.name = 'TestProposal';
    proposal.payment_address = 'DmPtF6UoguyK'; // payment address must be > 26 characters
    proposal.payment_amount = 10;
    proposal.start_epoch = startDate;
    proposal.type = 1;
        url:"http://www.duality.solutions"
  ...
  it('should throw error if payment address is P2SH', function() {
    ...
    proposal2.type = 1;
    proposal2.url = "https://www.duality.solutions/p/Proposal-36-DynamicATM";
  ...
  it('should parse a serialised datahex proposal', function(){
    ...
    var datahex1 = '';
    ...
    var datahex2_array = '';
    ...
    expect(proposal1.payment_address).to.equal('Dik5HAgVAgjH1oZKjcDfvcf22bwBNbSYzB');
    expect(proposal1.url).to.equal('https://www.duality.solutions/p/test_proposal_1519097947');
    ...
    expect(proposal2.payment_address).to.equal('DSaEYbbRqNj4PKbcB9uw6MPidHwoBBnhta');
  ...
  it('should handle a trigger', function () {
    ...
    var triggerDatahex1 = '';
