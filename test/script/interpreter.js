...
var script_valid = require('../data/dynamicd/script_valid');
var script_invalid = require('../data/dynamicd/script_invalid');
var tx_valid = require('../data/dynamicd/tx_valid');
var tx_invalid = require('../data/dynamicd/tx_invalid');

//the script string format used in dynamicd data tests
Script.fromDynamicdString = function(str) {
...
describe('Interpreter', function() {
  ...
  var testFixture = function(vector, expected) {
    var scriptSig = Script.fromDynamicdString(vector[0]);
    var scriptPubkey = Script.fromDynamicdString(vector[1]);
  ...
  describe('dynamicd script evaluation fixtures', function() {
  ...
  describe('dynamicd transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //dynamicd casts -1 to an unsigned int
            }
            map[txid + ':' + txoutnum] = Script.fromDynamicdString(scriptPubKeyStr);
          });
