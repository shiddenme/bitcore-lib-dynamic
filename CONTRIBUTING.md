...
#### T3 - Require 'dynamic' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the dynamic object.

DO:
```javascript
var dynamic = require('../');
var PublicKey = dynamic.PublicKey;
```
DON'T:
```javascript
