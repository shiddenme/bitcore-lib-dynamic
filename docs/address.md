# Dynamic Address
Represents a Dynamic address. Addresses are the most popular way to make Dynamic transactions.
...
```javascript
// from a string
var address = Address.fromString('DuUGDZHrKLo841CyamDbG5W7n59epA71h2');
...
The errors are listed in the generated file in the [errors folder](https://github.com/duality-solutions/bitcore-dynamic/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/duality-solutions/bitcore-dynamic/tree/master/lib/errors/spec.js).
